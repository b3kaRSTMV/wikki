      ...
      <div className={css.wrapper}>
        ...
        <div className={css.card_wrapper}>
            ...
            <div className={css.right}>
              ...
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
                  We have thought carefully about design so you don’t have to. You need only focus
                  on your content, we make it look amazing
                </h3>
              </div>
            </div>
          </div>
          <div className={css.card_container}>
            ...
            <div className={css.right}>
              <div className={css.title_container}>
                <h2 className={css.card_title}>FILES & MEDIA</h2>
              </div>
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
          ...
          <div className={css.card_container}>
            ...
            <div className={css.right}>
              ...
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
                  Every change made is stored so it is easy to compare pages, quickly see who made
                  which changes and revert changes
                </h3>
              </div>
            </div>
          </div>
          <div className={css.card_container}>
            ...
            <div className={css.right}>
              <div className={css.title_container}>
                <h2 className={css.card_title}>PRIVATE & SECURE</h2>
              </div>
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
          ...
          <div className={css.card_container}>
            ...
            <div className={css.right}>
              ...
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
                  Content can be visible to your whole company, restricted to a specific Team of
                  people or visible only to the content creator
                </h3>
              </div>
            </div>
          </div>
          <div className={css.card_container}>
            ...
            <div className={css.right}>
              <div className={css.title_container}>
                <h2 className={css.card_title}>FAST & EFFICIENT</h2>
              </div>
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
                  Careful optimization of the user experience and fast performance means a low
                  barrier for content creation and editing
                </h3>
              </div>
            </div>
          </div>
          ...
          <div className={css.card_container}>
            ...
            <div className={css.right}>
              <div className={css.title_container}>
                <h2 className={css.card_title}>PROFESSIONALLY DESIGNED TEMPLATES</h2>
              </div>
              <div className={css.main_text_container}>
                <h3 className={css.card_main_text}>
